<template>
  <div class="view">
    <h3>{{ $t('OutputIdenticon.title') }} #{{ identiconListNumber + 1 }}</h3>
    ...
    <h4>{{ $t('OutputIdenticon.instructions') }}</h4>
    <div class="input-module">
      <input type="text" maxlength="32" :placeholder="$t('OutputIdenticon.input')" v-model="inputString" @input="updateIdenticon" />
